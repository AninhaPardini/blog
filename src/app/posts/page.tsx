...
export default function PostPreview() {
  return (
    <div className="flex flex-col justify-center items-start py-16 w-full gap-8">
      <div>
        <h1
          className="flex justify-center items-center gap-2 text-2xl md:text-4xl font-bold text-white-950"
        >
          <NewspaperIcon className=" w-8 md:w-12 md:mr-2" />
          Últimos posts
        </h1>
      </div>
          ...
          <div className="lg:py-16">
            <div className="grid gap-8 lg:grid-cols-3">
              <ArticlePreview
                ...
                icon={Article} date="Há 1 mês"
                link="posts/figma-fundamentos"
              ...
              <ArticlePreview
                ...
                iconFill="" icon={Article} date="Há 1 mês"
                link="posts/componentes-js-html"
              ...
              <ArticlePreview
                ...
                iconFill="fill-mandy-800" icon={World} date="Em breve"
                link="posts/guia-figma-devs"
