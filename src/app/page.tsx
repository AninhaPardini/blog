    ...
    <div className='relative w-full px-4'>
      ...
      <header
        ...
        >
          ...
          >
            <h1
              className="text-3xl text-center m-auto md:m-0 md:text-left md:text-6xl text-white-950 font-extrabold"
            >
              Oie, sou Ana Pardini!
            </h1>
            <p
            ...
            <div
              className='flex justify-center w-full md:justify-start items-center gap-4'
            >
              <div
